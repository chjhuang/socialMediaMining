	...
	<div id="left_container" style="width: 20%;">
		<div id="information_zone" class="info_zone">
			...
			<form id="data">
					...
					<div class="attributeName">k: <input type="text" name="k" value=3 class="attributeValue" style="width:50px"></div>
		...
		<div id="right_container" style="width: 76%;">
			<div display="inline">
				<div id="main" style="height:93%;width:50%;float:left;"></div>
				<div id="main2" style="height:93%;width:50%;float:left;"></div>
			</div>
		</div>
	</div>
	<div id="footer">
